...
class _StaggeredAnimationsState extends State<StaggeredAnimations>
  ...
  bool _isDrawerOpen() {
    ...
    return _drawerSlideController.status == AnimationStatus.completed ||
  ...
  bool _isDrawerClosed() {
    ...
    return _drawerSlideController.status == AnimationStatus.dismissed ||
        _drawerSlideController.status == AnimationStatus.reverse;
  }
